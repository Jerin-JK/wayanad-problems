  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 py-12 px-6 md:px-12 selection:bg-cyan-500/30">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        {status === 'loading' ? (
          <div className="flex justify-center"><div className="animate-pulse h-12 w-32 bg-zinc-800 rounded-xl"></div></div>
        ) : !session ? (
          <div className="text-center bg-zinc-900/30 border border-zinc-800/80 p-12 rounded-3xl backdrop-blur-xl shadow-2xl space-y-8">
            <div>
              <h2 className="text-2xl font-bold mb-4">Sign in Required</h2>
              <p className="text-zinc-400 max-w-md mx-auto">You must be logged in to report a problem. This helps us ensure the authenticity of reported issues.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-sm mx-auto">
              <button
                onClick={() => signIn('google')}
                className="flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl border border-zinc-700 bg-zinc-800/50 hover:bg-zinc-800 hover:border-zinc-600 text-zinc-200 font-semibold text-sm transition-all"
              >
